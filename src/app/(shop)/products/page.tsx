    ...
    <div className="min-h-screen bg-zinc-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <div className="p-4">
                ...
                <div className="mt-4 flex justify-between items-center">
                  ...
                  <button className="px-4 py-2 bg-[#800000] text-white rounded-lg text-base hover:bg-[#600000] transition-colors duration-200">
                    View
                  </button>
                </div>
              </div>
        ...
        <div className="mt-10 text-center">
          <Link 
            href="/login" 
            className="inline-block px-6 py-3 bg-[#800000] text-white rounded-lg font-medium shadow-md hover:bg-[#600000] transition-colors duration-200 text-base"
          >
            Back to Login
          </Link>
        </div>
